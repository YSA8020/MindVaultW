-- ============================================================================
-- MindVault Simple Database Setup - NO CLEANUP
-- ============================================================================
-- This script creates all tables and functions without dropping existing ones
...
-- ============================================================================
-- PART 2: Professional Profiles Table
-- ============================================================================
...
DROP POLICY IF EXISTS "Users can view own professional profile" ON professional_profiles;
...
CREATE INDEX IF NOT EXISTS idx_failed_login_user ON failed_login_attempts(user_id);
...
-- ============================================================================
-- PART 5: Professional Onboarding Tables
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_checkpoints_professional ON onboarding_checkpoints(professional_id);
...
CREATE OR REPLACE FUNCTION initialize_professional_onboarding(
...
-- ============================================================================
-- PART 7: Professional Dashboard Tables
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_cpr_professional ON client_professional_relationships(professional_id);
CREATE INDEX IF NOT EXISTS idx_cpr_client ON client_professional_relationships(client_id);
...
CREATE INDEX IF NOT EXISTS idx_treatment_professional ON treatment_plans(professional_id);
CREATE INDEX IF NOT EXISTS idx_treatment_client ON treatment_plans(client_id);
...
CREATE INDEX IF NOT EXISTS idx_assessments_professional ON client_assessments(professional_id);
...
CREATE INDEX IF NOT EXISTS idx_notes_professional ON client_notes(professional_id);
CREATE INDEX IF NOT EXISTS idx_notes_client ON client_notes(client_id);
CREATE INDEX IF NOT EXISTS idx_notes_session ON client_notes(session_id);
...
CREATE INDEX IF NOT EXISTS idx_analytics_professional ON professional_analytics(professional_id);
...
CREATE OR REPLACE FUNCTION get_professional_dashboard_stats(
    p_professional_id UUID
)
RETURNS TABLE (
...
CREATE OR REPLACE FUNCTION get_professional_clients(
    p_professional_id UUID
)
RETURNS TABLE (
    client_id UUID,
...
CREATE OR REPLACE FUNCTION cleanup_old_activity_logs(p_days_to_keep INTEGER DEFAULT 30)
RETURNS INTEGER AS $$
DECLARE
    v_deleted_count INTEGER;
BEGIN
...
CREATE INDEX IF NOT EXISTS idx_anonymous_posts_user ON anonymous_posts(user_id);
CREATE INDEX IF NOT EXISTS idx_anonymous_posts_risk ON anonymous_posts(risk_level);
CREATE INDEX IF NOT EXISTS idx_anonymous_posts_created ON anonymous_posts(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_anonymous_posts_type ON anonymous_posts(post_type);
...
CREATE INDEX IF NOT EXISTS idx_emergency_post ON emergency_response_logs(post_id);
CREATE INDEX IF NOT EXISTS idx_emergency_user ON emergency_response_logs(user_id);
CREATE INDEX IF NOT EXISTS idx_emergency_status ON emergency_response_logs(response_status);
...
CREATE INDEX IF NOT EXISTS idx_backup_status ON backup_history(backup_status);
...
CREATE INDEX IF NOT EXISTS idx_restore_status ON restore_history(restore_status);
...
DO $$
BEGIN
    RAISE NOTICE '✅ MindVault database setup completed successfully!';
    RAISE NOTICE '📊 Created % tables', (SELECT COUNT(*) FROM information_schema.tables WHERE table_schema = 'public');
    RAISE NOTICE '⚙️  Created % functions', (SELECT COUNT(*) FROM information_schema.routines WHERE routine_schema = 'public');
END $$;
