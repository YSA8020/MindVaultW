-- ============================================================================
-- MindVault FINAL WORKING Database Setup Script
-- ============================================================================
-- This script combines all the working step-by-step tests
-- Run this in your Supabase SQL Editor
-- ============================================================================

-- ============================================================================
-- CLEANUP: Drop existing functions and views
-- ============================================================================
...
DROP POLICY IF EXISTS "Admins can view all security data" ON rate_limits;
...
DROP POLICY IF EXISTS "Admins can view all suspicious activity" ON suspicious_activity;
...
DROP POLICY IF EXISTS "Users can view own onboarding checkpoints" ON onboarding_checkpoints;
CREATE POLICY "Users can view own onboarding checkpoints" ON onboarding_checkpoints
    FOR ALL USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Public can view onboarding resources" ON onboarding_resources;
...
-- RLS Policies
DROP POLICY IF EXISTS "Professionals can view own client relationships" ON client_professional_relationships;
CREATE POLICY "Professionals can view own client relationships" ON client_professional_relationships
    FOR SELECT USING (auth.uid() = professional_id);

DROP POLICY IF EXISTS "Professionals can manage own client relationships" ON client_professional_relationships;
...
DROP POLICY IF EXISTS "Clients can view own relationships" ON client_professional_relationships;
CREATE POLICY "Clients can view own relationships" ON client_professional_relationships
    FOR SELECT USING (auth.uid() = client_id);

DROP POLICY IF EXISTS "Professionals can view own sessions" ON sessions;
...
DROP POLICY IF EXISTS "Professionals can view own treatment plans" ON treatment_plans;
CREATE POLICY "Professionals can view own treatment plans" ON treatment_plans
    FOR ALL USING (auth.uid() = professional_id);

DROP POLICY IF EXISTS "Clients can view own treatment plans" ON treatment_plans;
CREATE POLICY "Clients can view own treatment plans" ON treatment_plans
    FOR SELECT USING (auth.uid() = client_id);

DROP POLICY IF EXISTS "Professionals can view own assessments" ON client_assessments;
CREATE POLICY "Professionals can view own assessments" ON client_assessments
    FOR ALL USING (auth.uid() = professional_id);

DROP POLICY IF EXISTS "Clients can view own assessments" ON client_assessments;
CREATE POLICY "Clients can view own assessments" ON client_assessments
    FOR SELECT USING (auth.uid() = client_id);

DROP POLICY IF EXISTS "Professionals can view own notes" ON client_notes;
...
DROP POLICY IF EXISTS "Professionals can view own analytics" ON professional_analytics;
